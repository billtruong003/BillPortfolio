...
const CARD_CLASS =
    'group relative flex items-center gap-4 p-4 bg-zinc-900/50 border border-white/5 rounded-lg transition-all duration-300 min-w-[300px]';
            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {resumeData.certifications.map((cert, idx) => {
                        ...
                        // A credential without a verification link is still worth showing, but it must not
                        ...
                        return (
                            <a
                                ...
                                className={`${CARD_CLASS} hover:bg-white/5 hover:border-primary/30`}
                            >
                                {body}
                                <ExternalLink
                                    size={14}
                                    className="text-zinc-700 group-hover:text-zinc-400 absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-all"
                                />
                            </a>
                        );
                    })}
