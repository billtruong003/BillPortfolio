...
namespace ShootEmUp.Enemies
{
    ...
    {
        /// <summary>
        /// Raised when any enemy's Health reaches zero. Static so listeners (score, audio) do not need to track
        /// every pooled instance; the argument tells which type died.
        /// </summary>
